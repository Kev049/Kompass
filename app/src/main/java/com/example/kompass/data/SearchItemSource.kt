...
class SearchItemSource {
    fun loadSearchItems(): List<ProductItem> {
        return listOf<ProductItem>(
            ProductItem("SÄBÖVIK", "693.857.50", "Divan Bed", 3795, Category.BEDS_AND_MATTRESSES_S_BEDS, DimensionInfo(204, 140, 90, 200, 140), SustainabilityInfo(5, listOf("Polyester", "Steel", "Wood"), listOf("Sweden", "Sweden", "Norway")), listOf(
                ContentsCard("1 x Divan Bed", "140x200 cm", "SÄBÖVIK", R.drawable.sabovik_divanbed), ContentsCard("1 x Mattress", "140x200 cm", "SÄBÖVIK", R.drawable.sabovik_mattress)
            ), "Fabric:\n" +
            ...
            ProductItem("SKOTTERUD", "203.073.20", "Mattress", 2595,Category.BEDS_AND_MATTRESSES_S_MATTRESSES, DimensionInfo(205, 95, 60, 200, 90), SustainabilityInfo(15, listOf("Cotton", "Polyester", "Steel"), listOf("Spain", "Sweden", "Norway")), emptyList(),
              "Frame:\n" +
            ...
            ProductItem("MALM", "591.759.55", "Bed Frame", 2395, Category.BEDS_AND_MATTRESSES_S_BED_FRAMES, DimensionInfo(209, 156, 100, 200, 140), SustainabilityInfo(7, listOf("Foil", "Galvanized Steel", "Wood"), listOf("Spain", "Sweden", "Norway")), listOf(
            ...
            ProductItem("SLATTUM", "405.712.48", "Bed Frame", 1495, Category.BEDS_AND_MATTRESSES_S_BED_FRAMES, DimensionInfo(206, 164, 85, 200, 160), SustainabilityInfo(12, listOf("Foil", "Polyester", "Wood"), listOf("Denmark", "Germany", "Norway")), emptyList(), "Fabric:\n" +
                    "100% polyester (min. 90% recycled)\n" +
                    "\n" +
                    "Headboard:\n" +
                    "100 % polyester, Polyester wadding, Steel, Polyurethane foam 20 kg/cu.m.\n" +
...
//ProductItem("Slattum", "405.712.48", "Bed Frame", 1495, Category.BEDS_AND_MATTRESSES_S_SLATTUM, DimensionInfo(206, 164, 85, 200, 160), SustainabilityInfo(12, listOf("Foil", "Polyester", "Wood"), listOf("Denmark", "Germany", "Norway")), R.drawable.slattum),
